...
#选择职业院校
driver.find_element_by_xpath('//*[@id="bxrType" and @value="32"]').click()
#上传被保险人信息页面
time.sleep(1)
s=driver.find_element_by_xpath(".//*[@id='jichubaofei']")
Select(s).select_by_visible_text("300万元")
time.sleep(1)
...
f=open(foot,"a+")
f.write("\n（普通院校  300万  100人  12个月）："+Insure_single_number[4:].encode('utf-8'))
f.close()
driver.quit()
#-------上传单证-------
driver=webdriver.Firefox()
